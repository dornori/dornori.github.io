const ENV_CONFIG = {
  API_ENDPOINT:      globalThis.__ENV_API_ENDPOINT__ || 'https://dornori-ticketing.dornori-info.workers.dev',
  ...
  // NOTE: replace pk_test_SAMPLE_STRIPE_PUBLISHABLE_KEY with your real key via __ENV_STRIPE_KEY__
