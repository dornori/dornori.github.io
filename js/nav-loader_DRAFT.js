 ...
 * 2. Add { id: 'your-name', label: 'Your Label' } to the PROFILES array below
 * The selector in the settings bar will include it automatically.
 * ─────────────────────────────────────────────────────────────────────────────
 */
...
const PROFILES = [
    ...
    // { id: 'my-profile', label: 'My Profile' },  ← example: uncomment to add
];
...
export function initNavigation() {
    ...
    /* Build the profile <select> — replaces the old binary toggle button */
    ...
    if (topBar) {
        ...
        if (profileSelect) profileSelect.setAttribute('tabindex', '-1');
